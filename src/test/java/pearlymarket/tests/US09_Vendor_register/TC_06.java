...
public class TC_06 {
    /*
       ...
       Kullanici e mail kutucuguna valid bir deger girer 	japhet.abdoulaye@fullangle.org
       Kullanici verifcation text kutusuna tiklar
       "Kullanici Verification text kutusunun altinda  Verification code sent to your email:......yazisini görür"
       "Kullanici mail adresine gelen kodu  Verification code kutucuguna girer "
       Kullanci password kutucuguna tiklar
       Kullanci kucuk harf rakam ,ozel karakter iceren invalid bir sifre girer          ///////////	abc123@
       Kullanci password kutucugunun altinda hata mesaji görmez
    ...
    public void TC_06(){
        ...
        */
        ...
        // Kullanci kucuk harf rakam ,ozel karakter iceren invalid bir sifre girer 	abc123@
         home_pagehamit.password_kutucugu.sendKeys("abc123@");

        //Kullanci password kutucugunun altinda hata mesaji görmez
        Assert.assertTrue(!home_pagehamit.good_yazisi.getText().equals("invalid password"));
